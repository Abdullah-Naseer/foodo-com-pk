                    ...
                    <form action="{{ $action }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 mb-4">
                                ...
                                <textarea id="editor" class="form-control" rows="6" placeholder="Enter content">{{ old('content', $blog->content ?? '') }}</textarea>
      ...
      <script>
        $(document).ready(function() {
          ...
          ['view', []]
             ...
             document.querySelector('.standart-menu-form').addEventListener('submit', function(e) {
                const rawContent = $('#editor').summernote('code');
                const safeContent = JSON.stringify(rawContent);
                document.querySelector('#content-hidden').value = safeContent;
            });
