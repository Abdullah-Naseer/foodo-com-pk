<nav id="sidebar" class="sidebar js-sidebar">
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
            ...
            @can('budget')
                <li
                    class="sidebar-item {{ Route::is('admin.budget.*') || Route::is('admin.permissions.*') ? 'active' : '' }}">
                    <a href="#budget" data-bs-toggle="collapse"
                        class="sidebar-link {{ Route::is('admin.budget.*') || Route::is('admin.permissions.*') ? '' : 'collapsed' }}"
                        aria-expanded="{{ Route::is('admin.budget.*') || Route::is('admin.permissions.*') ? 'true' : 'false' }}">
                        <i class="align-middle me-2" data-feather="pie-chart"></i>
                        <span class="align-middle">Budget & Profit</span>
                    </a>
                    <ul id="budget"
                        class="sidebar-dropdown list-unstyled collapse {{ Route::is('admin.budget.*') || Route::is('admin.permissions.*') ? 'show' : '' }}"
                        data-bs-parent="#sidebar">
                        <li class="sidebar-item {{ Route::is('admin.budget.index') ? 'active' : '' }}">
                            <a class="sidebar-link" href="{{ route('admin.budget.index') }}">
                                List
                            </a>
                        </li>
                        <li class="sidebar-item {{ Route::is('admin.budget.stats') ? 'active' : '' }}">
                            <a class="sidebar-link" href="{{ route('admin.budget.stats') }}">
                                Stats
                            </a>
                        </li>
                    </ul>
